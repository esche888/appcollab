...
interface FeatureSuggestionCommentCreatedProps {
  ownerName: string
  projectTitle: string
...
export default function FeatureSuggestionCommentCreated({
...
}: FeatureSuggestionCommentCreatedProps) {
      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={section}>
            <Text style={heading}>New Comment on Feature Suggestion</Text>

            <Text style={text}>Hi {ownerName},</Text>

            <Text style={text}>
              {userName} just commented on a feature suggestion in your project <strong>{projectTitle}</strong>.
            </Text>

            <Text style={subheading}>
              On: <strong>{suggestionTitle}</strong>
            </Text>
