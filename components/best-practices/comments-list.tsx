...
import type { BestPracticeComment } from '@/types/database'

type CommentWithProfile = BestPracticeComment & {
  profiles: {
    id: string
    username: string
...
export function CommentsList({ bestPracticeId, refreshTrigger, currentUserId }: CommentsListProps) {
  ...
  const handleSaveEdit = async (commentId: string) => {
    ...
    try {
      const response = await fetch(
        `/api/best-practices/${bestPracticeId}/comments/${commentId}`,
        {
          method: 'PUT',
          headers: {
